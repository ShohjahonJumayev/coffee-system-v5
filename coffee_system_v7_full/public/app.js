...
const productSpecificImage=(name='',category='')=>{const n=String(name||'').toLowerCase(),c=String(category||'').toLowerCase();if(c.includes('айс кофе'))return '/assets/photos/iced-coffee.png';if(c.includes('айс матча'))return '/assets/photos/matcha.png';if(c.includes('чай'))return '/assets/photos/tea.png';if(c.includes('мохито'))return '/assets/photos/mojito.png';if(c.includes('милкшей'))return '/assets/photos/milkshake.png';if(c.includes('фреш'))return '/assets/photos/fresh.png';if(c.includes('лимонад')){if(n.includes('blue ocean'))return '/assets/photos/blue-lemonade.png';if(n.includes('класс'))return '/assets/photos/classic-lemonade.png';return '/assets/photos/fruit-lemonade.png';}if(c.includes('кофе'))return '/assets/photos/hot-coffee.png';return categoryFallbackImage(category);};
